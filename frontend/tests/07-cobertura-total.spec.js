...
const UI_COVERAGE_EVIDENCE = {
  ...
  cuotas_familias_regresiones: {
    ...
    tokens: [
      ...
      'pago familiar acepta sólo los integrantes realmente cobrables del contexto',
      'una cotización familiar vieja no puede cobrar un importe recalculado silenciosamente',
      ...
      'monto_esperado',
      'vinculos_historicos_preservados',
