...
const protectedActions = [
  ...
  ['cuotas_listar', 'GET'], ['cuotas_totales_estado', 'GET'], ['cuotas_catalogos', 'GET'], ['cuotas_contexto_pago', 'GET'], ['cuotas_contextos_pago', 'GET'],
  ['cuotas_registrar_inscripcion', 'POST'], ['cuotas_condonar_inscripcion', 'POST'], ['cuotas_eliminar_inscripcion', 'POST'],
